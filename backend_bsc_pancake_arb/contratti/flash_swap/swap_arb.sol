...
contract Arbitrage {
  ...
  address pancakeFactory = 0x6725F303b657a9451d8BA641348b6761A6CC7a17;  
  IUniswapV2Router02 bakeryRouter = IUniswapV2Router02(0xCDe540d7eAFE93aC5fE6233Bee57E1270D3E330F);
  ...
  function startArbitrage(
    ...
    uint token = IERC20(token0).balanceOf(address(this));
    require(token > 0, 'revert mio');
  }
...
/*  function pancakeCall(
    ...
    require(amountRequired < amountReceived, 'revert mio');
    otherToken.approve(address(pancakeRouter), amountRequired);
